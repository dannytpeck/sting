      ...
      <div className="modal-dialog modal-dialog-centered" role="document">
        <div className="modal-content">
          ...
          <div className="modal-body row" id="tileModalBody">
            ...
            <div className="col">
              <img className="tile-image" src={activity ? activity.ChallengeLogoURL : ''} />
              <h3 className="my-3">{activity ? activity.Name : ''}</h3>
              <div dangerouslySetInnerHTML={{ __html: activity ? activity.ShortDescription : '' }}></div>
              <div dangerouslySetInnerHTML={{ __html: activity ? activity.AboutChallenge : '' }}></div>
            </div>
          </div>
